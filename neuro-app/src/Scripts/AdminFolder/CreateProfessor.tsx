...
const CreateProfessor = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const url = "http://localhost:8192/professors/create";
        ...
        <div className="create-account-container">
          <div>
            <form onSubmit={handleSubmit} className="create-form">
              ...
              <label className="lab">
                Degree 
                <input className="inp" type="text" name="degree" value={formValues.degree} onChange={handleChange} />
              </label>
              <div className="but">
...
export default WithAuth(CreateProfessor, [0]);
